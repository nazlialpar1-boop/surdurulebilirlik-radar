  ...
  PROMPT = "Bugun " + TODAY + ". Turkiye surdurulebilirlik regulasyonlari 
  hakkinda JSON guncelleme ver. Format: {\"updates\": [{\"id\": \"" + TODAY +
  "-001\", \"date\": \"" + TODAY + "\", \"category\": \"Raporlama\", 
  \"categoryIcon\": \"📋\", \"title\": \"baslik\", \"summary\": \"aciklama\", 
  \"source\": \"kaynak\", \"sourceUrl\": \"\", \"tags\": [\"etiket\"], 
  \"importance\": \"high\"}]}"
